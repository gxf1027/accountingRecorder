...
CREATE TABLE `account_snapshot` (
  ...
  KEY `index_snap_userzh` (`user_id`,`zh_dm`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `audit_log` (
  ...
  `event_info` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
...
-- ----------------------------
-- Table structure for dm_event_type
-- ----------------------------
DROP TABLE IF EXISTS `dm_event_type`;
CREATE TABLE `dm_event_type` (
  `event_type_dm` int(11) NOT NULL,
  `event_type_mc` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `yxbz` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`event_type_dm`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `msg_log` (
  `msg_id` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '消息唯一标识',
...
) ENGINE=InnoDB AUTO_INCREMENT=101005 DEFAULT CHARSET=utf8 COMMENT='用户表';
